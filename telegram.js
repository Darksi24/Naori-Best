...
// Reemplaza con tu token real o usa process.env.BOT_TOKEN
const bot = new Telegraf(process.env.BOT_TOKEN || "7442347920:AAG7dHEtlVrqHEq-SJaPo8qsWilJbmsk7aM");
...
bot.on("new_chat_members", async (ctx) => {
  for (const user of ctx.message.new_chat_members) {
    ...
    await ctx.replyWithPhoto(
      "https://naori-best.vercel.app/welcome.jpg",
      {
